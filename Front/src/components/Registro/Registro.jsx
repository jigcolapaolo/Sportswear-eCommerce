const Registro = () => {
  return (
    <div
      ...
      style={{ 
        backgroundImage: 'linear-gradient(90deg, #E9AF31 0%, rgba(222, 157, 62, 0.94) 27.25%, rgba(224, 135, 79, 0.89) 56.98%, #D76A50 100%)',
        top: '882px',
        left: '1891px'
      }}
    >
      ...
      >
        ...
        <input type="number" placeholder="Ingresa el código de seguridad de la tarjeta" />
      </form>
      <button className="absolute" type="submit" style={{ top: '900px', left: '700px' }}>LISTO</button>
    </div>
  );
};
